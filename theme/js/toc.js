    ...
    window.Toc = {
        helpers: {
            findOrFilter: function (e, t) {
                ...
                var t = $(e).text(), r = t.trim().toLowerCase().replace(/[^A-Za-z0-9]+/g, "-");
                ...
                var t = this.generateAnchor(e), r = $(e), n = r.data("toc-text") || r.text();
            ...
            var t = this.helpers.createChildNavList(e.$nav), r = this.helpers.getTopLevel(e.$scope), n = this.helpers.getHeadings(e.$scope, r);
